 ...
 */
  ...
  *
  * EXAMPLE:
  *  getMiddleElement([ 10, null, "30", undefined, 300 ]);
  *  //> null
  */
 function getMiddleElement(array) { // Trystan
   let arr = array[(array.length - 1) / 2]
   return arr
 }
